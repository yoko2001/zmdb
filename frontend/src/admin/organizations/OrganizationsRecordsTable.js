...
export const OrganizationsRecordsTable = ({ records, refresh }) => {
    
    const rows = records
        .map(record => {
            const organization = JSON.parse(record.entity);
            return {
                id: record.id,
    ...
    const columns = [
        ...
        { field: 'organizationId', headerName: 'ID', flex:1, headerAlign:'center', align:'center' },
        ...
        { field: 'remark', headerName: '备注', flex:3, headerAlign:'center', align:'center' },
        { field: 'comment', headerName: '回复', flex:3, headerAlign:'center', align:'center' },
        { field:'operations', headerName:'操作', flex:3, headerAlign:'center', align:'center',renderCell:params => (
            params.value &&
